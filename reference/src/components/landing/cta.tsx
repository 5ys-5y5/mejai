      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-3xl text-zinc-500 mb-16 max-w-2xl mx-auto leading-relaxed">
            무료 데모를 통해 mejai.help의 <br className="hidden md:block" />
            압도적인 성능을 직접 경험해 보세요.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Button size="lg" className="h-16 px-12 text-xl rounded-full bg-black text-white hover:bg-zinc-800 transition-all">
              지금 시작하기
            </Button>
