...
export function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-white antialiased">
      ...
      <div className="container relative z-20 mx-auto px-6 text-center pt-20">
        ...
        >
          ...
          <p className="text-xl md:text-3xl font-medium text-zinc-500 tracking-tight mb-20 max-w-4xl mx-auto leading-tight">
            가장 진보된 AI가 당신의 유선 상담을 <br className="hidden md:block" />
            완벽한 데이터 자산으로 바꿉니다.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-32">
            <Button size="lg" className="h-20 px-14 text-2xl rounded-full bg-black text-white hover:bg-zinc-800 transition-all shadow-2xl active:scale-95">
              지금 시작하기 <ArrowRight className="ml-3 w-6 h-6" />
            </Button>
            <Button variant="ghost" size="lg" className="h-20 px-14 text-2xl rounded-full gap-3 hover:bg-zinc-50 font-bold active:scale-95 text-zinc-900">
      ...
      {/* 고해상도 AI 오라 그래픽 (Apple Intelligence 스타일) */}
