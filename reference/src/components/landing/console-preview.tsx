...
import { LayoutDashboard, Phone, BarChart2, Book, Settings, ShieldCheck } from "lucide-react";
        ...
        <div className="flex flex-col lg:flex-row items-center gap-20">
          <div className="lg:w-1/2">
            ...
            <p className="text-xl md:text-2xl text-zinc-500 leading-relaxed mb-12">
              상담의 모든 과정을 턴 단위로 분석하고 실시간으로 지식을 교정하세요. <br className="hidden md:block" />
              mejai.help는 운영자에게 강력하고 직관적인 도구를 제공합니다.
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {[
                { title: "실시간 로그", desc: "턴 단위 대화 타임라인", icon: Phone },
                { title: "분석 엔진", desc: "트렌드 및 만족도 통계", icon: BarChart2 },
                { title: "지식 허브", desc: "정책 및 FAQ 관리", icon: Book },
