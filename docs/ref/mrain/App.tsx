...
export default function App() {
  ...
  return (
    <div className="relative w-full h-screen bg-white overflow-hidden">
      ...
      {/* Optional: Overlay to credit or show title, can be removed if pure canvas desired */}
      <div className="absolute bottom-4 right-4 pointer-events-none opacity-50">
        <p className="text-black font-['Apple_SD_Gothic_Neo'] text-xs">
          Matrix Rain / White Edition
        </p>
      </div>
    </div>
  );
