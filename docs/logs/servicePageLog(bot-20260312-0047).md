...
SESSION_ID: bf1a62c5-41f8-4661-9b78-6b1a5aa96a13
PAGE: /app/laboratory
KIND: conversation
...
TURN_ID: 9318865a-9607-4c32-b3ad-f77a1dc4ebbd
...
BOT:
요약: 선정 절차에 대한 정보는 KB에 없습니다. 다른 KB 주제를 알려주시면 도와드리겠습니다.
근거: KB 및 정책에 따라 처리했습니다.
상세: 선정 절차에 대한 정보는 KB에 없습니다. 다른 KB 주제를 알려주시면 도와드리겠습니다.
다음 액션: 추가 요청이 있으면 알려주세요.
RESPONSE_SCHEMA: view=text, choice_mode=single, quick_replies=0, cards=0
RESPONSE_SCHEMA_DETAIL:
  {
    "message": "확인한 것: 선정 절차 어떻게 돼?\n확인할 것: 선정 절차에 대한 정보는 KB에 없습니다. 다른 KB 주제를 알려주시면 도와드리겠습니다.\n그 다음으로 확인할 것: 다음 단계로 이어서 안내해 드리겠습니다.",
    "ui_hints": {
      "view": "text",
      "choice_mode": "single"
    },
...
[TOKEN_UNUSED]
DEBUG 로그:
- c06b9188-2ef8-4575-b6c7-60918bba1e31 (turn_id=9318865a-9607-4c32-b3ad-f77a1dc4ebbd) (2026-03-11T15:47:16.988+00:00)
  prefix_json:
    {
      "kb": {
        "primary": {
      ...
      "decision": {
        ...
        "module_path": "src/app/api/runtime/chat/runtime/runtimeTurnIo.ts",
        "recorded_at": "2026-03-11T15:47:16.826Z",
        "function_name": "insertTurnWithDebug"
      },
      "kb_admin": {
...
이벤트 로그:
- d96a2801-257d-4944-bee1-3b2a8912dafa FINAL_ANSWER_READY (2026-03-11T15:47:21.168+00:00) (turn_id=9318865a-9607-4c32-b3ad-f77a1dc4ebbd)
  payload:
    {
      "model": "gpt-4.1-mini",
      "answer": "확인한 것: 선정 절차 어떻게 돼?\n확인할 것: 선정 절차에 대한 정보는 KB에 없습니다. 다른 KB 주제를 알려주시면 도와드리겠습니다.\n그 다음으로 확인할 것: 다음 단계로 이어서 안내해 드리겠습니다.",
      "_decision": {
        "line": 248,
        "phase": "after",
        "column": 0,
        ...
        "module_path": "src/app/api/runtime/chat/runtime/finalizeRuntime.ts",
        "recorded_at": "2026-03-11T15:47:21.168Z",
        "function_name": "emit:FINAL_ANSWER_READY"
      },
      "debug_answer": "요약: 선정 절차에 대한 정보는 KB에 없습니다. 다른 KB 주제를 알려주시면 도와드리겠습니다.\n근거: KB 및 정책에 따라 처리했습니다.\n상세: 선정 절차에 대한 정보는 KB에 없습니다. 다른 KB 주제를 알려주시면 도와드리겠습니다.\n다음 액션: 추가 요청이 있으면 알려주세요."
    }
- d568ac23-804f-48e4-8c95-a24d4fca445f RUNTIME_SELF_UPDATE_REVIEW_COMPLETED (2026-03-11T15:47:21.002+00:00) (turn_id=9318865a-9607-4c32-b3ad-f77a1dc4ebbd)
  payload:
    {
      "org_id": "8ad81b6b-3210-40dd-8e00-9a43a4395923",
      "turn_id": "9318865a-9607-4c32-b3ad-f77a1dc4ebbd",
...
- a9819926-5d13-4c6f-b40f-7b826e13cce7 RUNTIME_SELF_UPDATE_REVIEW_STARTED (2026-03-11T15:47:20.362+00:00) (turn_id=9318865a-9607-4c32-b3ad-f77a1dc4ebbd)
  payload:
    {
      "org_id": "8ad81b6b-3210-40dd-8e00-9a43a4395923",
      "turn_id": "9318865a-9607-4c32-b3ad-f77a1dc4ebbd",
...
- 37750f25-4040-43eb-a016-bb4e14902207 END_USER_WRITE_LATENCY (2026-03-11T15:47:19.718+00:00) (turn_id=9318865a-9607-4c32-b3ad-f77a1dc4ebbd)
  payload:
    {
      "duration_ms": 2560
    }
- e5cd4a8c-a102-4c7c-a77d-8245a78f9a2b END_USER_CONTEXT_RESOLVED (2026-03-11T15:47:18.078+00:00) (turn_id=9318865a-9607-4c32-b3ad-f77a1dc4ebbd)
  payload:
    {
      "match_hit": true,
...
- 3d93333f-2e15-44f6-8546-726370d8151d END_USER_MATCH_HIT (2026-03-11T15:47:17.909+00:00) (turn_id=9318865a-9607-4c32-b3ad-f77a1dc4ebbd)
  payload:
    {
      "matched": true,
      "identity_count": 1,
...
- e9f93d1a-ab1b-4125-8333-e5e449962c06 KB_LLM_ANSWER_READY (2026-03-11T15:47:16.643+00:00) (turn_id=9318865a-9607-4c32-b3ad-f77a1dc4ebbd)
  payload:
    {
      "model": "gpt-4.1-mini",
      "_decision": {
        ...
        "call_chain": [],
        "module_path": "unknown",
        "recorded_at": "2026-03-11T15:47:16.643Z",
        "function_name": "unknown"
      },
      "answer_length": 49,
      "evidence_keys": []
    }
- 3bd0ed4c-d106-4720-9872-8e727a8b0170 KB_LLM_PROMPT_BUILT (2026-03-11T15:47:14.866+00:00) (turn_id=9318865a-9607-4c32-b3ad-f77a1dc4ebbd)
  payload:
    {
      "_decision": {
        "phase": "runtime",
        "call_chain": [],
        "module_path": "unknown",
        "recorded_at": "2026-03-11T15:47:14.866Z",
        "function_name": "unknown"
      },
      "kb_topics": [
        "재입고"
...
- 31a2db19-eaf0-497a-a497-63f98856f09b INTENT_ROUTED (2026-03-11T15:47:14.702+00:00) (turn_id=9318865a-9607-4c32-b3ad-f77a1dc4ebbd)
  payload:
    {
      "_decision": {
        "phase": "runtime",
        "call_chain": [],
        "module_path": "unknown",
        "recorded_at": "2026-03-11T15:47:14.701Z",
        "function_name": "unknown"
      },
      "intent_route": "kb_answer",
...
- 8737b4b3-e9b4-4309-bdab-2dff7a40248d KB_MATCH_COMPLETED (2026-03-11T15:47:14.54+00:00) (turn_id=9318865a-9607-4c32-b3ad-f77a1dc4ebbd)
  payload:
    {
      "key": null,
      "score": null,
      ...
      "_decision": {
        ...
        "call_chain": [],
        "module_path": "unknown",
        "recorded_at": "2026-03-11T15:47:14.540Z",
        "function_name": "unknown"
      },
      "source_kb_id": null,
      "source_kb_title": null
    }
- aed5d88d-d4d3-486a-9fcc-e0c40dcc0b56 KB_MATCH_STARTED (2026-03-11T15:47:14.376+00:00) (turn_id=9318865a-9607-4c32-b3ad-f77a1dc4ebbd)
  payload:
    {
      "kb_id": "__INLINE_KB__",
      "_decision": {
        ...
        "call_chain": [],
        "module_path": "unknown",
        "recorded_at": "2026-03-11T15:47:14.376Z",
        "function_name": "unknown"
      },
      "query_text": "선정 절차 어떻게 돼?",
      "admin_kb_ids": []
    }
