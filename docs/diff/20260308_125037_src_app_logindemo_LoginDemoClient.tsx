...
export default function LoginDemoClient() {
  ...
  const [policyWidgetSrc, setPolicyWidgetSrc] = useState(() =>
    buildWidgetUrl({
      parameter: "1",
      "widget.tabBar.enabled": "1",
      "widget.tabBar.policy": "1",
      "widget.setupPanel": "1",
      tab: "policy",
    })
  );
  ...
  return (
    <AuthShell title="다시 오신 것을 환영합니다" footer={null} showBrand={false} showTitle={false} contentMarginTop="none">
      <div className="space-y-6">
        ...
        <div className="w-full overflow-hidden rounded-2xl border border-slate-200" style={{ height: 300 }}>
          <iframe
            title="Login demo widget (policy)"
            src={policyWidgetSrc}
