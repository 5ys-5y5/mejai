  ...
  const handleSetupAgentChange = useCallback(
    (value: string) =>
      updateDraft((current) => {
        ...
        if (nextAgentId) {
          nextFeatures = setIn(nextFeatures as any, ["setup", "defaultSetupMode"], null);
    ...
    <PanelVariantContext.Provider value={variant}>
      <div className="space-y-4">
        <ToggleRowGroup
          ...
          displayLabel={widgetActiveLabel}
        ...
        >
          ...
          >
            ...
            <RowGroup label="allowDeny" displayLabel="Allow/Deny">
...
function Row({
  ...
  const resolvedCodeLabel = codeLabel || (displayLabel ? label : undefined);
