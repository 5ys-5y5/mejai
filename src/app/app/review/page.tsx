  ...
  return (
    <div className="px-5 md:px-8 py-6">
      <div className="mx-auto w-full max-w-6xl">
        <h1 className="text-2xl font-semibold text-slate-900">리뷰 요청</h1>
        ...
        <Card className="mt-4">
          <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200">
            <div className="text-sm font-semibold text-slate-900">리뷰 대기 목록</div>
            ...
            {items.map((r) => (
              <li key={r.id} className="p-4 hover:bg-slate-50">
                ...
                <div className="mt-2 flex flex-wrap items-center gap-2 text-xs">
                  <IconChip icon={CheckCircle2} label={`담당자 ${r.owner || "미지정"}`} />
                  <Link
