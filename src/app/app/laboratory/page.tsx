      ...
      <div className="mx-auto w-full max-w-6xl">
        ...
        <ConversationWorkbenchTopBar
          ...
          leading={
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">LLM, KB, MCP, Route 조합을 실험하고 응답을 확인하세요.</p>
        ...
        <div className="mt-6 space-y-6">
          ...
          {!ctrl.loading && !ctrl.error && ctrl.kbItems.length === 0 ? (
            ...
            <div className="text-sm text-slate-500">비어있는 KB가 없습니다. 신규 모드에서는 KB 없이도 가능하지만, 기존 모드에서는 KB/에이전트가 필요합니다.</div>
